...
Se você está recebendo erro ao tentar acessar o site:
...
### 2. GitHub Actions (Automático - Recomendado)
...
```
https://wolfcolorssp-svg.github.io/wolf-colors-ERP/
https://wolfcolorssp-svg.github.io/wolf-colors-ERP/login
```
...
├── vite.config.js      # Configuração do Vite (base: /wolf-colors-ERP/)
...
3. **Implementar estados** com Context API
...
npm install
npm run build
# Pasta dist/ contém os arquivos prontos para GitHub Pages
```
